...
//                WIFI_AP_STATE_ENABLED = 13;
    ...
    public static List<WifiClient> getWifiApClientList() {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (mac.matches("..:..:..:..:..:..")) {
                    if ("0x2".equals(flag) /*&& InetAddress.getByName(ip).isReachable(1000)*/) {//bug pc ipv6 连接没计算连接数
    ...
    public static ReportData.Sim2Bean getSim2(Context context) {
        TelephonyManager tm = (TelephonyManager) context.getApplicationContext().
                getSystemService(Context.TELEPHONY_SERVICE);
        ReportData.Sim2Bean sim2 = new ReportData.Sim2Bean();
        try {
            //返回设备的当前位置
            ...
            for (CellInfo cellInfo : cellInfoList) {
                ...
                //CDMA手机信息
                    ...
                    if (cellInfo.isRegistered()) {
                        ...
                        sim2.setCi(basestationId);
                        sim2.setLac(networkId);
                        sim2.setSignal(dbm);
                        sim2.setPsc(systemId);
                        break;
                    }
